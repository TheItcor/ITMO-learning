...
#2
2
пригательный сложный пригательной основа пригательный

#3
1
Большой город и большой парк. В Большом театре идет спектакль.

#4
3
Старый дом стоял на высоком холме. Старая береза росла рядом. Старые яблони цвели в саду.

#5
2
Небольшой дом и очень большой сад. Большой город и небольшой поселок.
...
public class Informatics_Lab3_Task3 {
    public static final String[] ends = {"ого","ему","ому","ыми","ими","ых","их","ая","ое","ые","ий","ый","ой","ым","им","ом","ым"};
    ...
    public static void main(String[] args) {
        ...
        // Ищем прилагательные
        Pattern p = Pattern.compile("(?U)\\b[А-Яа-яЁё]+?(?:ый|ий|ой|ая|ое|ые|ого|ему|ому|ым|им|ых|их|ом)\\b");
